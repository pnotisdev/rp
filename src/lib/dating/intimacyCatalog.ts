...
export const DEFAULT_INTIMACY_CATALOG: IntimacyUnlockable[] = [
  ...
  { id: 'pos-spooning', category: 'position', label: 'spooning', minWarmth: 55, minCommitment: 'dating', actionText: "*I fit myself against {char}'s back, both of us on our sides, and pull them in close by the hip.*", promptNote: "spooning: you at {char}'s back, both on your sides, close enough there's no space left between you, one hand free to roam or hold" },
  { id: 'pos-against-wall', category: 'position', label: 'against the wall', minWarmth: 90, minCommitment: 'exclusive', actionText: "*I back {char} into the wall and lift them, their legs coming up around me, my forearm braced beside their head.*", promptNote: "{char} pinned against the wall with their legs around you, held up by you entirely, nothing under them to brace against" },
