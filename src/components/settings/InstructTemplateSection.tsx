...
export function InstructTemplateSection() {
  ...
  return (
    <Section
      ...
      description="How turns are formatted for the model — match this to your model's training format. Duplicate a builtin below to tweak it, then save it as your own."
      surface="bare"
    >
